...
const crossPlatformModels: Model[] = [
  ...
  // -------- Qwen3.5 (official: https://huggingface.co/Qwen/Qwen3.5-2B; GGUF from community) --------
  {
    ...
    hfUrl: 'https://huggingface.co/Qwen/Qwen3.5-2B',
    progress: 0,
    ...
    hfModelFile: {
      rfilename: 'Qwen3.5-2B-Q4_K_M.gguf',
      url: 'https://huggingface.co/unsloth/Qwen3.5-2B-GGUF/resolve/main/Qwen3.5-2B-Q4_K_M.gguf',
      size: 1280835840,
      oid: '2dd42a93d110e1a333c7464693e3c38b979a940e',
      lfs: {
        oid: 'aaf42c8b7c3cab2bf3d69c355048d4a0ee9973d48f16c731c0520ee914699223',
        size: 1280835840,
        pointerSize: 135,
      },
      canFitInStorage: true,
